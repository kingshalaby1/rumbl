defmodule RumblWeb.VideoController do
  ...
  @doc """
  Each controller is also a plug. To call a controller, Phoenix invokes the default action function at the end of the controller pipeline. We’re replacing it because we want to change the API for all of our controller actions. It’s easy enough. We call apply to call our action the way we want.
  """
